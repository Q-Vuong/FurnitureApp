...
app.get("/", function (req, res) {
  ...
  const successMessage = req.query.success === 'newpass' ? 'Mật khẩu đổi thành công. Vui lòng đăng nhập lại với mật khẩu mới!' : null;
  res.render("login.hbs", { dangerMessage, successMessage});
});
